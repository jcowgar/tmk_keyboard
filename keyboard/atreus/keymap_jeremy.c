...
#define KM_BSOP ACTION_MODS_TAP_KEY(MOD_LALT, KC_BSPC) // LALT or Backspace
#define KM_DLCD ACTION_MODS_TAP_KEY(MOD_LGUI, KC_DEL) // LGUI or Delete
...
#define CM_COLN ACTION_MODS_KEY(MOD_LSFT, KC_P) // Colemak to Qwerty in software playing games
...
[ALPH] = {
  ...
  {KC_A,    KC_FN0,  KC_FN1,  KC_F,    KC_G,    KC_TRNS, KC_H,    KC_J,    KC_FN2,  KC_FN3,  KC_SCLN},
  {KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KM_BSOP, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH},
  {KC_LCTL, KC_FN4,  KC_NO,   KC_TAB,  KC_SPC,  KM_DLCD, KC_ENT,  KC_LSFT, KC_NO,   KC_ESC,  KC_RCTL}
},
[NUMS] = {
...
[CURS] = {
  ...
  {KC_TRNS, KC_TRNS, KC_FN4,  KC_TRNS, KC_TAB,  KM_CUT,  KM_PAST, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS}
},
[SYMB] = {
...
const uint16_t PROGMEM fn_actions[] = {
	[0] = ACTION_LAYER_TAP_KEY(NUMS, KC_S),
	[1] = ACTION_LAYER_TAP_KEY(FKEY, KC_D),
	[2] = ACTION_LAYER_TAP_KEY(CURS, KC_K),
	[3] = ACTION_LAYER_TAP_KEY(SYMB, KC_L),
  [4] = ACTION_FUNCTION(BOOTLOADER)
};
